...
class Book implements Comparable<Object>{
    ...
    public int compareTo(Object o){
        Book j = (Book) o;
        return (this.title).compareTo(j.title);// need to modify the code in here
    }
    ...
    */
    ...
    public double compare(Book b){
        Book k = (Book) b;
        if(compares(b)==0){
            return this.price - k.price;
        }
        else
            return author.compareTo(b.author);//need to modify the code here
    }
}
    class BookStore{
        ...
        */
        ...
        public Book binarySearch(String title){
            ...
            return null;//must modify the code in here
        }
}
class Driver
{
